...
func init() {
	...
	//rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.cobra_gen.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".cobra_gen" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".vision_cfg")
	}
